...
- generated: 2026-09-21T04:52:15.547255Z
- run directory: `$REPO/evidence/phase4_1/runs/20260921T045116Z-g3_1-m2b-chainB`

| case | package | status | assertions | subcases | first finding |
| --- | --- | --- | --- | --- | --- |
| W16_T019_chainB_transient | W16 | FAIL | 20 | 8 | the transient decay deviates by 1.788e-03 (limit 1.0e-03) at {'t_s': 0.5, 'x_m': 0.005, 'T_k': 312.2457226380793, 'T_analytic_k': 312.20996050531596} |
...
- `FAIL` [live] normalized_max_error_le_1e-3 — the transient decay deviates by 1.788e-03 (limit 1.0e-03) at {'t_s': 0.5, 'x_m': 0.005, 'T_k': 312.2457226380793, 'T_analytic_k': 312.20996050531596}
...
- `W16_T019_chainB_transient` → **IMPLEMENTATION_GAP** (classified): the transient decay deviates by 1.788e-03 (limit 1.0e-03) at {'t_s': 0.5, 'x_m': 0.005, 'T_k': 312.2457226380793, 'T_analytic_k': 312.20996050531596}
...
- logical requests planned (run/case/step/sequence keys): 33
