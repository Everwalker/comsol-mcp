...
- generated: 2026-09-21T07:53:25.936819Z
- run directory: `$REPO/evidence/phase4_1/runs/20260921T075313Z-g3_1-chainAC`

| case | package | status | assertions | subcases | first finding |
| --- | --- | --- | --- | --- | --- |
| W16_T019_chainA_steady | W16 | PASS | 26 | 14 |  |
| W16_T019_chainC_continue | W16 | FAIL | 17 | 7 | the derived-value nodes could not be enumerated after the continuation |
...
- `FAIL` [live] derived_values_and_data_association_preserved — the derived-value nodes could not be enumerated after the continuation
...
- recorded UNKNOWN jobs: 1 (released: 1, unreleased: 0)
- calls that stayed refused after the release path ran: 0

- `2213349d-5733-4cf1-bdf5-b6f362911f41` (operation_call): released=True, attempts=1, reconciled_quiescent=True, status=UNKNOWN
...
- `W16_T019_chainC_continue` → **IMPLEMENTATION_GAP** (classified): the derived-value nodes could not be enumerated after the continuation
...
- logical requests planned (run/case/step/sequence keys): 39
...
- dispatch stages recorded: dispatched 37, dispatched_without_mutation 1, unknown 1
- generation replacements observed: 0
- deliberate negative probes (never auto-repaired): 0
- unfinished jobs known to the context: 1
