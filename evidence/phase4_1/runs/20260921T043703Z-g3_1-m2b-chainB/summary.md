...
- generated: 2026-09-21T04:37:39.679418Z
- run directory: `$REPO/evidence/phase4_1/runs/20260921T043703Z-g3_1-m2b-chainB`

| case | package | status | assertions | subcases | first finding |
| --- | --- | --- | --- | --- | --- |
| W16_T019_chainB_transient | W16 | FAIL | 20 | 8 | the transient decay deviates by 4.697e-02 (limit 1.0e-03) at {'t_s': 1.0, 'x_m': 0.005, 'T_k': 308.393543177073, 'T_analytic_k': 307.45415677706876} |
...
- `FAIL` [live] normalized_max_error_le_1e-3 — the transient decay deviates by 4.697e-02 (limit 1.0e-03) at {'t_s': 1.0, 'x_m': 0.005, 'T_k': 308.393543177073, 'T_analytic_k': 307.45415677706876}
...
- `W16_T019_chainB_transient` → **IMPLEMENTATION_GAP** (classified): the transient decay deviates by 4.697e-02 (limit 1.0e-03) at {'t_s': 1.0, 'x_m': 0.005, 'T_k': 308.393543177073, 'T_analytic_k': 307.45415677706876}
...
- dispatch stages recorded: dispatched 30, dispatched_without_mutation 1
