...
- generated: 2026-09-21T03:45:10.239914Z
- run directory: `$REPO/evidence/phase4_1/runs/20260921T034600Z-g3_1-m2a-chainA`
...
- `a8c5fc17-0eb8-4a01-a6e3-8bbfe0f6fe6a` (operation_call): released=True, attempts=2, reconciled_quiescent=True, status=UNKNOWN
- `e840671d-557c-493b-850b-ab12fac3300a` (operation_call): released=True, attempts=2, reconciled_quiescent=True, status=UNKNOWN
- `db58be2a-b602-40e3-b936-468ecd4df456` (operation_call): released=True, attempts=2, reconciled_quiescent=True, status=UNKNOWN
- `3b7d7f15-2413-4ad3-ae1d-a5fa35f739cb` (operation_call): released=True, attempts=2, reconciled_quiescent=True, status=UNKNOWN
- `7cf909a7-d0f4-457c-8e69-525f3fba4d6e` (operation_call): released=True, attempts=2, reconciled_quiescent=True, status=UNKNOWN
...
- dispatch stages recorded: dispatched 16, dispatched_without_mutation 6, unknown 2
