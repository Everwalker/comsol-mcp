...
- generated: 2026-09-21T01:05:45.899739Z
- run directory: `$REPO/evidence/phase4_1/runs/20260921T010537Z-g3_1-m1f`
...
- `3fb16f16-adf1-4fc9-b871-0da3404324ed` (operation_call): released=True, attempts=2, reconciled_quiescent=True, status=UNKNOWN
- `1605d67a-be85-4502-aaf7-0c2d4cb9d3d6` (operation_call): released=True, attempts=2, reconciled_quiescent=True, status=UNKNOWN
- `ad2b79e3-8077-4430-85a0-f6ea3777829f` (operation_call): released=True, attempts=2, reconciled_quiescent=True, status=UNKNOWN
- `a3776e08-8aa5-48c5-ac66-4bf251ffe750` (operation_call): released=True, attempts=2, reconciled_quiescent=True, status=UNKNOWN
- `f9605f43-ba97-4000-9d0a-59ca6e2d5097` (operation_call): released=True, attempts=2, reconciled_quiescent=True, status=UNKNOWN
- `54dfb86a-aef9-430c-b607-ace25865d902` (operation_call): released=True, attempts=2, reconciled_quiescent=True, status=UNKNOWN
- `c76b02fb-cad2-4c7d-bdac-148460506384` (operation_call): released=True, attempts=2, reconciled_quiescent=True, status=UNKNOWN
- `ac0588f9-e2ec-4a36-b9b4-51e61736b88b` (create_feature): released=True, attempts=1, reconciled_quiescent=True, status=UNKNOWN
- `e08a3c17-3b11-4ab2-adac-a560e451b1eb` (create_feature): released=True, attempts=1, reconciled_quiescent=True, status=UNKNOWN
- `8561b4a2-d66d-4c99-b2c8-534dbb7fa998` (create_feature): released=True, attempts=1, reconciled_quiescent=True, status=UNKNOWN
- `31c543ab-fc66-422c-9e86-b5410267d64a` (operation_call): released=True, attempts=2, reconciled_quiescent=True, status=UNKNOWN
...
- `R04_LIVE`: isolation=own_model (applied=True) — the stale-revision probe must not dirty the shared model; prerequisites=SATISFIED; shared binding restored: mcp13
...
- `GUARD_T033`: isolation=own_model (applied=True) — the evaluation-policy probes need a clean, validly bound model that no earlier refusal has dirtied; prerequisites=SATISFIED; shared binding restored: mcp13
