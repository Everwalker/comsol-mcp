...
public final class ChainBBuilder {
    public static Object run(Model model, Map<String, Object> args) {
        model.param().set("p1", "1"); model.param().set("p2", "3"); model.modelNode().create("comp1");
        ...
        model.study("std1").create("param", "Parametric");model.study("std1").feature("param").set("pname", new String[]{"p1","p2"});model.study("std1").feature("param").set("plistarr", new String[]{"1 2","3 4"});model.study("std1").feature("param").set("punit", new String[]{"",""});model.study("std1").feature("param").set("sweeptype", "filled");model.study("std1").run();
