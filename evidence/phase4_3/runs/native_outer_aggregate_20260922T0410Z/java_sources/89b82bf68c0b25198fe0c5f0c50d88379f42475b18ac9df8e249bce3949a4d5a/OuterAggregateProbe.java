  ...
  for(String kind:new String[]{"AvSurface","IntSurface"}) {
   ...
   try {
    ...
    for(int outer=1;outer<=4;outer++) {
     ...
     vals.put("default_real",n.getReal()); vals.put("default_imag",n.getImag());
     vals.put("explicit_real",n.getReal(false,outer)); vals.put("explicit_imag",n.getImag(false,outer));
