/*
 * Config4d9d37a1a45c4cf2bed901b0229f2306.java
 */

import com.comsol.model.*;
import com.comsol.model.util.*;

/** Model exported on Sep 26 2026, 07:34 by COMSOL 6.4.0.293. */
public class Config4d9d37a1a45c4cf2bed901b0229f2306 {

  public static Model run() {
    Model model = ModelUtil.create("Model");

    model.modelPath("C:\\Temp\\w22_20260926\\smoke64_02\\project\\w21\\config");

    model.label("W22Owned");

    model.param().set("L", "0.02[m]");
    model.param().set("p0", "0.8[W]");
    model.param().set("p1", "0.75[W]");
    ...
    model.func("b0g0")
         .set("filename", "C:\\Temp\\w22_20260926\\smoke64_02\\runtime\\tmp\\csmphserver97826\\basis_l0_g0.txt");
    ...
    model.func("b0g1")
         .set("filename", "C:\\Temp\\w22_20260926\\smoke64_02\\runtime\\tmp\\csmphserver97826\\basis_l0_g1.txt");
    ...
    model.func("b0g2")
         .set("filename", "C:\\Temp\\w22_20260926\\smoke64_02\\runtime\\tmp\\csmphserver97826\\basis_l0_g2.txt");
    ...
    model.func("b1g0")
         .set("filename", "C:\\Temp\\w22_20260926\\smoke64_02\\runtime\\tmp\\csmphserver97826\\basis_l1_g0.txt");
    ...
    model.func("b1g1")
         .set("filename", "C:\\Temp\\w22_20260926\\smoke64_02\\runtime\\tmp\\csmphserver97826\\basis_l1_g1.txt");
    ...
    model.func("b1g2")
         .set("filename", "C:\\Temp\\w22_20260926\\smoke64_02\\runtime\\tmp\\csmphserver97826\\basis_l1_g2.txt");
    ...
    model.func("b2g0")
         .set("filename", "C:\\Temp\\w22_20260926\\smoke64_02\\runtime\\tmp\\csmphserver97826\\basis_l2_g0.txt");
    ...
    model.func("b2g1")
         .set("filename", "C:\\Temp\\w22_20260926\\smoke64_02\\runtime\\tmp\\csmphserver97826\\basis_l2_g1.txt");
    ...
    model.func("b2g2")
         .set("filename", "C:\\Temp\\w22_20260926\\smoke64_02\\runtime\\tmp\\csmphserver97826\\basis_l2_g2.txt");
    ...
    model.variable("v1")
         .set("incident", "if(abs(L-0.01[m])<1e-9[m],p0.0*b0g0(x,y),0[W/m^2])+if(abs(L-0.01[m])<1e-9[m],p1.0*b0g1(x,y),0[W/m^2])+if(abs(L-0.01[m])<1e-9[m],p2.0*b0g2(x,y),0[W/m^2])+if(abs(L-0.02[m])<1e-9[m],p0.0*b1g0(x,y),0[W/m^2])+if(abs(L-0.02[m])<1e-9[m],p1.0*b1g1(x,y),0[W/m^2])+if(abs(L-0.02[m])<1e-9[m],p2.0*b1g2(x,y),0[W/m^2])+if(abs(L-0.03[m])<1e-9[m],p0.0*b2g0(x,y),0[W/m^2])+if(abs(L-0.03[m])<1e-9[m],p1.0*b2g1(x,y),0[W/m^2])+if(abs(L-0.03[m])<1e-9[m],p2.0*b2g2(x,y),0[W/m^2])");
    model.variable("v1").set("qabs", "alpha*incident");
    ...
    model.variable("v1").set("roi_max", "mxroi(T-Tamb)");
    model.variable("v1").set("roi_min", "mnroi(T-Tamb)");
    model.variable("v1").set("Pinc", "itop(incident)");
    model.variable("v1").set("Pabs", "itop(qabs)");
    model.variable("v1").set("Proi", "iroi(qabs)");
    model.variable("v1").set("Pout", "ibot(500[W/(m^2*K)]*(T-Tamb))");
