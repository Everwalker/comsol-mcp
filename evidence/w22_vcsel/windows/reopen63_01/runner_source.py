        ...
        async with stdio_client(params) as (read,write):
            async with ClientSession(read,write) as session:
                ...
                if args.reopen:
                    ...
                    assert summary['stored_before_rebind']['data']['values']==prior['final_sample']['data']['values'], 'stored results changed'
                    ...
                    assert summary['stored_after_rebind']['data']['values']==prior['final_sample']['data']['values'], 'external data rebind changed fields'
