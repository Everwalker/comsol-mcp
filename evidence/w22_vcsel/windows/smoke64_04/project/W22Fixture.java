...
public final class W22Fixture {
    ...
    public static Object run(Model model, Map<String,Object> args) {
        ...
        for(Map<String,Object> src:sources) {
            ...
            expr.append("if(abs(L-").append(src.get("L_m")).append("[m])<1e-9[m],p").append(((Number)src.get("group_index")).intValue()).append("*").append(fn).append("(x,y),0[W/m^2])");
        }
        model.component("comp1").variable().create("v1");
        model.component("comp1").variable("v1").set("incident",expr.toString());model.component("comp1").variable("v1").set("qabs","alpha*incident");
        ...
        model.component("comp1").variable("v1").set("roi_max","mxroi(T-Tamb)");model.component("comp1").variable("v1").set("roi_min","mnroi(T-Tamb)");
        model.component("comp1").variable("v1").set("Pinc","itop(incident)");model.component("comp1").variable("v1").set("Pabs","itop(qabs)");
        model.component("comp1").variable("v1").set("Proi","iroi(qabs)");model.component("comp1").variable("v1").set("Pout","ibot(500[W/(m^2*K)]*(T-Tamb))");
