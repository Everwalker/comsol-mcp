/*
 * Config015f537853b04e6c97b710427480dacf.java
 */

import com.comsol.model.*;
import com.comsol.model.util.*;

/** Model exported on Sep 25 2026, 19:34 by COMSOL 6.4.0.293. */
public class Config015f537853b04e6c97b710427480dacf {

  public static Model run() {
    Model model = ModelUtil.create("Model");

    model.modelPath("C:\\Temp\\w21closure_20260925\\smoke64_08\\project\\w21\\config");
    ...
    model.param().set("k", "380.0[W/(m*K)]");
    model.param().set("rhoCp", "3400000.0[J/(m^3*K)]");
