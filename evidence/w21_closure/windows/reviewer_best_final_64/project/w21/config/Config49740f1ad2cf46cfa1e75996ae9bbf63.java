/*
 * Config49740f1ad2cf46cfa1e75996ae9bbf63.java
 */

import com.comsol.model.*;
import com.comsol.model.util.*;

/** Model exported on Sep 25 2026, 21:58 by COMSOL 6.4.0.293. */
public class Config49740f1ad2cf46cfa1e75996ae9bbf63 {

  public static Model run() {
    Model model = ModelUtil.create("Model");

    model.modelPath("C:\\Temp\\w21closure_20260925\\reviewer_best_final_64\\project\\w21\\config");

    model.label("ReviewerBestIndependent");

    model.param().set("L", "0.05[m]");
    model.param().set("k", "390.0[W/(m*K)]");
