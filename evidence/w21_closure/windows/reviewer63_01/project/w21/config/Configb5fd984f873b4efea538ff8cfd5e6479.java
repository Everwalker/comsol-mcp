/*
 * Configb5fd984f873b4efea538ff8cfd5e6479.java
 */

import com.comsol.model.*;
import com.comsol.model.util.*;

/** Model exported on Sep 25 2026, 20:15 by COMSOL 6.3.0.290. */
public class Configb5fd984f873b4efea538ff8cfd5e6479 {

  public static Model run() {
    Model model = ModelUtil.create("Model");

    model.modelPath("C:\\Temp\\w21closure_20260925\\reviewer63_01\\project\\w21\\config");

    model.label("ReviewerIndependent");

    model.param().set("L", "0.05[m]");
    model.param().set("k", "399.0[W/(m*K)]");
