/*
 * Configa9dab2fae0ad4ed1af37bad669eec816.java
 */

import com.comsol.model.*;
import com.comsol.model.util.*;

/** Model exported on Sep 25 2026, 19:26 by COMSOL 6.4.0.293. */
public class Configa9dab2fae0ad4ed1af37bad669eec816 {

  public static Model run() {
    Model model = ModelUtil.create("Model");

    model.modelPath("C:\\Temp\\w21closure_20260925\\smoke64_07\\project\\w21\\config");
    ...
    model.param().set("k", "400.0[W/(m*K)]");
    model.param().set("rhoCp", "3800000.0[J/(m^3*K)]");

    model.study("std1").run();

    model.result().numerical().create("cmssp1", "Interp");
    model.result().numerical("cmssp1").set("data", "dset1");
    model.result().numerical("cmssp1").set("expr", new String[]{"T"});
    model.result().numerical("cmssp1").run();
    model.result().numerical().remove("cmssp1");
