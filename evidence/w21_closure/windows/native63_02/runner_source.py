            ...
            async with ClientSession(read,write) as session:
                ...
                if args.reopen:
                    ...
                    for mode,levels in [('mesh',[(8,'1e-8'),(16,'1e-8'),(32,'1e-8')]),('time',[(32,'1e-3'),(32,'1e-5'),(32,'1e-7')])]:
                        ...
                        convergence=await call('validate.convergence',{'cases':[{'level':c['level'],'error':c['error'],'tolerance':c['rtol'],'mesh_size_metric':c['mesh_size_metric']} for c in cases],
...
if __name__=='__main__':
    ...
    p.add_argument('--comsol',required=True);p.add_argument('--jdk',required=True);p.add_argument('--fixture',required=True);p.add_argument('--reopen');p.add_argument('--refinement',action='store_true')
