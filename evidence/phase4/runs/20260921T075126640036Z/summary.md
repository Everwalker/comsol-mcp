...
- generated: 2026-09-21T07:51:28.335494Z
- run directory: `$REPO/evidence/phase4/runs/20260921T075126640036Z`
...
### W16_T019_chainC_continue — NOT_RUN
- `PASS` [static] static_chain_c_ops_availability
- `PASS` [fixture] user_style_model_available
- `NOT_RUN` [live] target_only_modified — offline run: --live was not supplied
- `NOT_RUN` [live] non_target_nodes_preserved — offline run: --live was not supplied
- `NOT_RUN` [live] manual_solver_preserved — offline run: --live was not supplied
- `NOT_RUN` [live] derived_values_and_data_association_preserved — offline run: --live was not supplied
- `NOT_RUN` [live] solve_after_continuation — offline run: --live was not supplied
...
- dispatch stages recorded: dispatched 2, unknown 2
