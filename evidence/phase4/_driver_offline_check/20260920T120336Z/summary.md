...
- generated: 2026-09-20T12:03:39.208186Z
- run directory: `$REPO/evidence/phase4/_driver_offline_check/20260920T120336Z`
...
| W14_T034_local_paths | W14 | BLOCKED | 5 | 5 | required operation(s) not executable in this build: geometry.import(implementation_status=PROPOSED_NOT_IMPLEMENTED) |
...
| W15_T042_license | W15 | BLOCKED | 3 | 5 | required operation(s) not executable in this build: runtime.license_inspect(implementation_status=PROPOSED_NOT_IMPLEMENTED), runtime.capabilities(implementation |
...
| W16_T019_chainA_steady | W16 | BLOCKED | 5 | 12 | required operation(s) not executable in this build: geometry.feature_create(implementation_status=PROPOSED_NOT_IMPLEMENTED), geometry.build(implementation_statu |
| W16_T019_chainB_transient | W16 | BLOCKED | 4 | 6 | required operation(s) not executable in this build: geometry.feature_create(implementation_status=PROPOSED_NOT_IMPLEMENTED), geometry.build(implementation_statu |
| W16_T019_chainC_continue | W16 | BLOCKED | 4 | 7 | required operation(s) not executable in this build: study.step_update(implementation_status=PROPOSED_NOT_IMPLEMENTED), study.run(implementation_status=PROPOSED_ |
...
cases: PASS 1 / FAIL 0 / BLOCKED 13 / NOT_RUN 9
...
- `BLOCKED` [static] static_model_path_ops_availability — required operation(s) not executable in this build: geometry.import(implementation_status=PROPOSED_NOT_IMPLEMENTED)
...
- `BLOCKED` [static] static_license_ops_availability — required operation(s) not executable in this build: runtime.license_inspect(implementation_status=PROPOSED_NOT_IMPLEMENTED), runtime.capabilities(implementation_status=PROPOSED_NOT_IMPLEMENTED)
- `BLOCKED` [live] license_inspect_records_has_product — required operation(s) not executable in this build: runtime.license_inspect(implementation_status=PROPOSED_NOT_IMPLEMENTED), runtime.capabilities(implementation_status=PROPOSED_NOT_IMPLEMENTED)
- `BLOCKED` [live] missing_product_blocks_with_blocked_license — required operation(s) not executable in this build: runtime.license_inspect(implementation_status=PROPOSED_NOT_IMPLEMENTED), runtime.capabilities(implementation_status=PROPOSED_NOT_IMPLEMENTED)
- `BLOCKED` [live] authorized_product_usable — required operation(s) not executable in this build: runtime.license_inspect(implementation_status=PROPOSED_NOT_IMPLEMENTED), runtime.capabilities(implementation_status=PROPOSED_NOT_IMPLEMENTED)
- `BLOCKED` [live] probe_does_not_occupy_license — required operation(s) not executable in this build: runtime.license_inspect(implementation_status=PROPOSED_NOT_IMPLEMENTED), runtime.capabilities(implementation_status=PROPOSED_NOT_IMPLEMENTED)
...
- `BLOCKED` [static] static_chain_a_ops_availability — required operation(s) not executable in this build: geometry.feature_create(implementation_status=PROPOSED_NOT_IMPLEMENTED), geometry.build(implementation_status=PROPOSED_NOT_IMPLEMENTED), material.create(implementation_status=PROPOSED_NOT_IMPLEMENTED), material.set_properties(implementation_status=PROPOSED_NOT_IMPLEMENTED), material.selection_set(implementation_status=PROPOSED_NOT_IMPLEMENTED), physics.create(implementation_status=PROPOSED_NOT_IMPLEMENTED), physics.feature_create(implementation_status=PROPOSED_NOT_IMPLEMENTED), mesh.create(implementation_status=PROPOSED_NOT_IMPLEMENTED), mesh.feature_create(implementation_status=PROPOSED_NOT_IMPLEMENTED), mesh.build(implementation_status=PROPOSED_NOT_IMPLEMENTED), study.create(implementation_status=PROPOSED_NOT_IMPLEMENTED), study.step_create(implementation_status=PROPOSED_NOT_IMPLEMENTED), study.run(implementation_status=PROPOSED_NOT_IMPLEMENTED), result.sample_path(implementation_status=PROPOSED_NOT_IMPLEMENTED)
...
- `BLOCKED` [static] static_chain_c_ops_availability — required operation(s) not executable in this build: study.step_update(implementation_status=PROPOSED_NOT_IMPLEMENTED), study.run(implementation_status=PROPOSED_NOT_IMPLEMENTED), solver.inspect(implementation_status=PROPOSED_NOT_IMPLEMENTED)
