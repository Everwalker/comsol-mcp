...
- generated: 2026-09-20T12:04:34.350678Z
- run directory: `$REPO/evidence/phase4/_driver_offline_check/20260920T120431Z`
...
| W16_T018_mesh | W16 | BLOCKED | 4 | 7 | required operation(s) not executable in this build: mesh.feature_update(implementation_status=unknown) |
...
cases: PASS 1 / FAIL 0 / BLOCKED 12 / NOT_RUN 10
...
- `BLOCKED` [static] static_mesh_ops_availability — required operation(s) not executable in this build: mesh.feature_update(implementation_status=unknown)
- `BLOCKED` [live] free_tet_sequence_created — required operation(s) not executable in this build: mesh.feature_update(implementation_status=unknown)
- `BLOCKED` [live] local_size_feature_applied — required operation(s) not executable in this build: mesh.feature_update(implementation_status=unknown)
- `BLOCKED` [live] modify_and_rebuild — required operation(s) not executable in this build: mesh.feature_update(implementation_status=unknown)
- `BLOCKED` [live] statistics_counts_and_coverage — required operation(s) not executable in this build: mesh.feature_update(implementation_status=unknown)
- `BLOCKED` [live] quality_definition_and_low_quality_locations — required operation(s) not executable in this build: mesh.feature_update(implementation_status=unknown)
